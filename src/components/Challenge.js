  ...
  return (
    <div>
      <div className="headup">
        <div className="dcod">
          <Link to="/task">
            <h2 className="cod">TASK OF THE DAY</h2>
          </Link>
          ...
          <div className="codpic" />
        </div>
        <div className="dmow">
          <Link to="/cod">
            <h2 className="mow">CHALLENGE OF THE WEEK</h2>
          </Link>
          <div className="emowdiv">
            <h3 className="emow">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit.
              Voluptatem veritatis dolore soluta nulla quisquam reiciendis
              tempore molestias repudiandae, minima animi autem alias ipsam
        ...
        <div className="daom">
          <Link to="/mission">
            <h2 className="aom">MISSION OF THE MONTH</h2>
          </Link>
          <div className="eaomdiv">
            <h3 className="eaom">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit.
              Voluptatem veritatis dolore soluta nulla quisquam reiciendis
              tempore molestias repudiandae, minima animi autem alias ipsam
